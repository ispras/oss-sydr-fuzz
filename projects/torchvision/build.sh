...
Torch_DIR=/pytorch_fuzz/ \ 
	...
	-DJPEG_LIBRARY=/libjpeg-turbo-2.1.3-fuzz/build/libjpeg.a \
	-DPNG_LIBRARY=/libpng-1.6.37-fuzz/build/libpng.a \
	-DZLIB_LIBRARY=/zlib_fuzz/libz.a \
	-Donnx_LIBRARY=/pytorch_fuzz/build/lib/libonnx.a \
	-Donnx_proto_LIBRARY=/pytorch_fuzz/build/lib/libonnx_proto.a \
	-Dfoxi_loader_LIBRARY=/pytorch_fuzz/build/lib/libfoxi_loader.a \
