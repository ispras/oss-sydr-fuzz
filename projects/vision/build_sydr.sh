...
cmake -G"Unix Makefiles" -DCMAKE_C_COMPILER=clang -DCMAKE_CXX_COMPILER=clang++ -DENABLE_STATIC=1 -DENABLE_SHARED=0 -DWITH_JPEG8=1 -DCMAKE_C_FLAGS="-g" -S . -B build/
cd build/
make -j$(nproc)
...
cd zlib-1.2.12-sydr/
CC=clang CXX=clang++ CFLAGS="-g" CXXFLAGS="-g" ./configure
make -j$(nproc)

# Build torchvision
cd /vision_sydr/
Torch_DIR=/pytorch_sydr/ cmake -DCMAKE_C_COMPILER=clang -DCMAKE_CXX_COMPILER=clang++ -DCMAKE_C_FLAGS="-g" -DCMAKE_CXX_FLAGS="-g -I/pytorch_sydr/torch/csrc/api/include -I/pytorch_sydr/torch/include -I/libjpeg-turbo-2.1.3-sydr/" -S . -B build/
...
clang++ -DAT_PER_OPERATOR_HEADERS -DCPUINFO_SUPPORTED_PLATFORM=1 -DFMT_HEADER_ONLY=1 -DFXDIV_USE_INLINE_ASSEMBLY=0 -DHAVE_MALLOC_USABLE_SIZE=1 -DHAVE_MMAP=1 -DHAVE_SHM_OPEN=1 -DHAVE_SHM_UNLINK=1 -DMINIZ_DISABLE_ZIP_READER_CRC32_CHECKS -DNNP_CONVOLUTION_ONLY=0 -DNNP_INFERENCE_ONLY=0 -DONNXIFI_ENABLE_EXT=1 -DONNX_ML=1 -DONNX_NAMESPACE=onnx_torch -DUSE_EXTERNAL_MZCRC -D_FILE_OFFSET_BITS=64 -DUSE_PTHREADPOOL -DNDEBUG -DUSE_KINETO -DLIBKINETO_NOCUPTI -DUSE_QNNPACK -DUSE_PYTORCH_QNNPACK -DUSE_XNNPACK -DSYMBOLICATE_MOBILE_DEBUG_HANDLE -DEDGE_PROFILER_USE_KINETO -DTH_HAVE_THREAD -g -O2 -I/pytorch_sydr/torch/include /decode_png_fuzz.cc -I/pytorch_sydr/torch/csrc/api/include -I/vision_sydr/torchvision/csrc/io/image -I/vision_sydr/torchvision/csrc/io/image/cpu -I/libpng-1.6.37-sydr/ -c -o ./decode_png_sydr.o

# Link decode_png_sydr target

clang++ -g -O2 -std=gnu++14 -DNDEBUG ./decode_png_sydr.o /pytorch_sydr/torch/lib/libtorch.a \
./main.o \
-Wl,--whole-archive,"/pytorch_sydr/build/lib/libtorch.a" -Wl,--no-whole-archive \
-Wl,--whole-archive,"/pytorch_sydr/build/lib/libtorch_cpu.a" -Wl,--no-whole-archive \
/vision_sydr/build/libtorchvision.a /pytorch_sydr/build/lib/libbreakpad.a \
...
clang++ -DAT_PER_OPERATOR_HEADERS -DCPUINFO_SUPPORTED_PLATFORM=1 -DFMT_HEADER_ONLY=1 -DFXDIV_USE_INLINE_ASSEMBLY=0 -DHAVE_MALLOC_USABLE_SIZE=1 -DHAVE_MMAP=1 -DHAVE_SHM_OPEN=1 -DHAVE_SHM_UNLINK=1 -DMINIZ_DISABLE_ZIP_READER_CRC32_CHECKS -DNNP_CONVOLUTION_ONLY=0 -DNNP_INFERENCE_ONLY=0 -DONNXIFI_ENABLE_EXT=1 -DONNX_ML=1 -DONNX_NAMESPACE=onnx_torch -DUSE_EXTERNAL_MZCRC -D_FILE_OFFSET_BITS=64 -DUSE_PTHREADPOOL -DNDEBUG -DUSE_KINETO -DLIBKINETO_NOCUPTI -DUSE_QNNPACK -DUSE_PYTORCH_QNNPACK -DUSE_XNNPACK -DSYMBOLICATE_MOBILE_DEBUG_HANDLE -DEDGE_PROFILER_USE_KINETO -DTH_HAVE_THREAD -g -O2 -I/libjpeg-turbo-2.1.3-sydr/ -I/pytorch_sydr/torch/include /encode_jpeg_fuzz.cc -I/pytorch_sydr/torch/csrc/api/include -I/vision_sydr/torchvision/csrc/io/image -I/vision_sydr/torchvision/csrc/io/image/cpu -c -o ./encode_jpeg_sydr.o

# Link decode_jpeg_sydr target

clang++ -g -O2 -std=gnu++14 -DNDEBUG ./encode_jpeg_sydr.o /pytorch_sydr/torch/lib/libtorch.a \
./main.o \
-Wl,--whole-archive,"/pytorch_sydr/build/lib/libtorch.a" -Wl,--no-whole-archive \
-Wl,--whole-archive,"/pytorch_sydr/build/lib/libtorch_cpu.a" -Wl,--no-whole-archive \
/vision_sydr/build/libtorchvision.a /pytorch_sydr/build/lib/libbreakpad.a \
...
clang++ -DAT_PER_OPERATOR_HEADERS -DCPUINFO_SUPPORTED_PLATFORM=1 -DFMT_HEADER_ONLY=1 -DFXDIV_USE_INLINE_ASSEMBLY=0 -DHAVE_MALLOC_USABLE_SIZE=1 -DHAVE_MMAP=1 -DHAVE_SHM_OPEN=1 -DHAVE_SHM_UNLINK=1 -DMINIZ_DISABLE_ZIP_READER_CRC32_CHECKS -DNNP_CONVOLUTION_ONLY=0 -DNNP_INFERENCE_ONLY=0 -DONNXIFI_ENABLE_EXT=1 -DONNX_ML=1 -DONNX_NAMESPACE=onnx_torch -DUSE_EXTERNAL_MZCRC -D_FILE_OFFSET_BITS=64 -DUSE_PTHREADPOOL -DNDEBUG -DUSE_KINETO -DLIBKINETO_NOCUPTI -DUSE_QNNPACK -DUSE_PYTORCH_QNNPACK -DUSE_XNNPACK -DSYMBOLICATE_MOBILE_DEBUG_HANDLE -DEDGE_PROFILER_USE_KINETO -DTH_HAVE_THREAD -g -O2 -I/pytorch_sydr/torch/include /encode_png_fuzz.cc -I/pytorch_sydr/torch/csrc/api/include -I/vision_sydr/torchvision/csrc/io/image -I/vision_sydr/torchvision/csrc/io/image/cpu -I/libpng-1.6.37-sydr/ -c -o ./encode_png_sydr.o

# Link encode_png_sydr target

clang++ -g -O2 -std=gnu++14 -DNDEBUG ./encode_png_sydr.o /pytorch_sydr/torch/lib/libtorch.a \
./main.o \
-Wl,--whole-archive,"/pytorch_sydr/build/lib/libtorch.a" -Wl,--no-whole-archive \
-Wl,--whole-archive,"/pytorch_sydr/build/lib/libtorch_cpu.a" -Wl,--no-whole-archive \
/vision_sydr/build/libtorchvision.a /pytorch_sydr/build/lib/libbreakpad.a \
